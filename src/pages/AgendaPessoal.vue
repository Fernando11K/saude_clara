  ...
  <q-page>
    <div class="row justify-center">
      <div class="col-12 col-md-8">
        <agendaPessoal-component title="Agenda Pessoal" :agendas="agendaPessoa">
        </agendaPessoal-component>
      </div>
    </div>
  </q-page>
</template>
...
import AgendaPessoalComponent from 'components/ListaAgendaComponent.vue';

const agendaPessoa = ref<Agenda[]>([
  {
    id: 1,
    idExame: 2,
